...
export const NewsDetail = () => {
  ...
  const getContent = () => {
    switch (language) {
      case 'en':
        return {
          intro: 'Lam An Spa offers luxurious treatments inspired by traditional Hue imperial therapies. Our experienced therapists combine ancient techniques with modern wellness practices.',
          ...
          closing: 'Visit Lam An Spa today and discover the perfect balance of tradition and modern luxury. Book your appointment through Messenger or call us at 0905 686 226.'
        };
      case 'ko':
        return {
          intro: 'Lam An Spa는 전통적인 후에 황실 치료법에서 영감을 받은 고급스러운 트리트먼트를 제공합니다. 숙련된 치료사들이 고대 기술과 현대 웰니스 관행을 결합합니다.',
          section1Title: '전통 유산',
          ...
          closing: '오늘 Lam An Spa를 방문하여 전통과 현대 럭셔리의 완벽한 균형을 발견하세요. 메신저를 통해 예약하거나 0905 686 226으로 전화하세요.'
        };
      default:
        return {
          intro: 'Lam An Spa mang đến những liệu trình sang trọng lấy cảm hứng từ y học cung đình Huế truyền thống. Đội ngũ kỹ thuật viên giàu kinh nghiệm của chúng tôi kết hợp kỹ thuật cổ xưa với các phương pháp chăm sóc sức khỏe hiện đại.',
          ...
          closing: 'Ghé thăm Lam An Spa ngay hôm nay và khám phá sự cân bằng hoàn hảo giữa truyền thống và sang trọng hiện đại. Đặt lịch hẹn qua Messenger hoặc gọi cho chúng tôi theo số 0905 686 226.'
        };
    }
  };
    ...
    <div className="min-h-screen bg-[#FDF8F4]">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            {/* Excerpt */}
            <div className="bg-[#3D5647] text-white p-8 rounded-lg mb-12">
            ...
            <div className="mb-12">
              <h2
                className="text-3xl font-light mb-6 text-[#3D5647]"
            ...
            {/* CTA Section */}
            <div className="mt-16 bg-[#3D5647] text-white p-8 rounded-lg text-center">
              <h3
              ...
              <motion.a
                ...
                className="inline-flex items-center gap-3 px-8 py-3 bg-white text-[#3D5647] rounded-full hover:bg-[#D4AF37] hover:text-white transition-all duration-300 font-medium"
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <button className="w-10 h-10 rounded-full bg-[#3D5647] text-white flex items-center justify-center hover:bg-[#D4AF37] transition-colors">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </button>
          ...
          >
            <h3
              className="text-2xl md:text-3xl font-normal mb-8 text-[#3D5647]"
              style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 400 }}
            >
              Bài viết liên quan
            </h3>
