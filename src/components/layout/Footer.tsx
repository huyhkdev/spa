...
export const Footer = () => {
  ...
  return (
    <footer className="text-white" style={{ backgroundColor: '#C89358' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3
              className="text-3xl font-bold mb-2 text-[#D4AF37]"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:0905686226" className="text-sm text-white/80 hover:text-[#D4AF37] transition-colors">
                  0905 686 226
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail size={16} className="text-[#D4AF37]" />
                <a href="mailto:maiaspahue@gmail.com" className="text-sm text-white/80 hover:text-[#D4AF37] transition-colors">
                  maiaspahue@gmail.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8zm-3.5-9a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zm7 0a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z"/>
                </svg>
              </a>
            </div>
          </div>
